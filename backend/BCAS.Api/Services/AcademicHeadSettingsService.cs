...
public class AcademicHeadSettingsService : IAcademicHeadSettingsService
{
    private readonly IUserRepository _userRepository;
    private readonly IAuthService _authService;
    private readonly ILogger<AcademicHeadSettingsService> _logger;

    public AcademicHeadSettingsService(IUserRepository userRepository, IAuthService authService, ILogger<AcademicHeadSettingsService> logger)
    {
