...
public class SupportStaffSettingsService : ISupportStaffSettingsService
{
    private readonly IUserRepository _userRepository;
    private readonly IAuthService _authService;
    private readonly ILogger<SupportStaffSettingsService> _logger;

    public SupportStaffSettingsService(IUserRepository userRepository, IAuthService authService, ILogger<SupportStaffSettingsService> logger)
    {
